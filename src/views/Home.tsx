...
const faqs = [
  { q: "How to fill a medical certificate?", a: "A medical certificate must be filled by a registered doctor — not the patient. It should include the patient's name, age, and gender; the date of examination; the diagnosis or reason for leave; the recommended rest period; and the doctor's name, qualifications, registration number, signature, and clinic stamp." },
  { q: "What does a medical certificate look like?", a: "A typical Indian medical certificate has three parts. The header shows the clinic name and doctor details. The middle section includes patient details, diagnosis, and rest period. The bottom section has the doctor's signature, official stamp, and a follow-up date." },
  { q: "How to get a medical certificate from a doctor offline?", a: "Visit any registered MBBS or MD doctor. Describe your symptoms honestly; the doctor will examine you. After the consultation, explicitly ask for a medical certificate specifying the number of rest days needed." },
  { q: "How to make a medical certificate for college?", a: "Visit a registered doctor during your illness period. Ask for a certificate specifying the exact dates you were unwell. Check your institution's rules, as some require certificates specifically from government hospitals." },
  { q: "What is Medical Certificate Form 1A?", a: "Medical Certificate Form 1A is a standardised government form in India used primarily for driving licence medical fitness certification under the Motor Vehicles Act, requiring physical checks like vision and hearing." },
  { q: "Is a medical certificate generator tool legal to use?", a: "Generating sample certificates for educational purposes or UI testing is legal. Using any generated certificate as a real document to deceive constitutes fraud under Indian law." },
  { q: "Are these certificates valid for sick leave?", a: "No. Certificates generated by this tool are not valid for sick leave or official purposes. To get a valid sick leave certificate, you must visit a licensed, registered doctor." },
