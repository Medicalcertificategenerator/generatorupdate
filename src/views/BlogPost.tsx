  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 w-full">
          ...
          <div className="max-w-3xl mx-auto px-4 py-12">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-5">
              ...
              <span className="text-xs text-muted-foreground flex items-center gap-1">
                ...
                <Link href="/author" className="hover:text-primary hover:underline transition-colors">
                  {post.author}
                </Link>
              </span>
              {post.reviewedBy && (
                <span className="text-xs text-muted-foreground flex items-center gap-1">
                  ...
                  <span className="font-medium text-foreground">{post.reviewedBy}</span>
                </span>
              )}
            </div>
        ...
        {/* Author attribution */}
        <div className="max-w-3xl mx-auto px-4 pb-10 flex flex-col sm:flex-row gap-4">
          <div className="flex-1 bg-card border border-border rounded-xl p-5 flex gap-4 items-center">
            ...
            <div>
              <p className="font-bold text-sm">Written by <Link href="/author" className="text-primary hover:underline">Ziven Borceg</Link></p>
              <p className="text-xs text-muted-foreground">Software developer and creator of medicalcertificategenerator.co.in</p>
            </div>
          </div>
          {post.reviewedBy && (
            <div className="flex-1 bg-card border border-border rounded-xl p-5 flex gap-4 items-center">
              <div className="w-12 h-12 rounded-full bg-green-500/10 text-green-600 flex items-center justify-center flex-shrink-0">
                <Stethoscope className="w-6 h-6" />
              </div>
              <div>
                <p className="font-bold text-sm text-foreground">Reviewed by Medical Professional</p>
                <p className="text-xs text-muted-foreground font-medium">{post.reviewedBy}</p>
                <p className="text-[10px] text-muted-foreground mt-0.5">Verified via the National Medical Commission (NMC) Registry.</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="max-w-3xl mx-auto px-4">
          <GamAdSlot slotId="div-gpt-ad-1785160436458-0-blog5" />
        </div>
