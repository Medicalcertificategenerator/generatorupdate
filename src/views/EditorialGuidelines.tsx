...
import { BookOpen, ShieldCheck, RefreshCw, AlertTriangle, CheckCircle, ExternalLink, Search, FileText, Users, History, HelpCircle, Link2 } from "lucide-react";
...
const sections = [
  ...
  },
  {
    ...
    bg: "bg-purple-500/10",
    title: "Recent Content Updates (2026)",
    content: (
      <div className="space-y-6 text-foreground/80 leading-relaxed relative pl-4 border-l-2 border-primary/20 ml-2">
        {[
          ...
          { date: "April 2026", text: "Added official Telemedicine Practice Guidelines 2020 references to 3 core articles." },
          { date: "March 2026", text: "Initial publication of 20+ comprehensive informational articles with expert peer-review." },
        ].map((item, idx) => (
  ...
  },
  {
    ...
    bg: "bg-indigo-500/10",
    title: "Content Based on Real User Questions",
    content: (
      <div className="space-y-4 text-foreground/80 leading-relaxed">
        <p>
          Our editorial topics are never generated in a vacuum; they are directly driven by the real-world informational needs of Indian users. We actively monitor search trends for local medical certificate formats, employer-specific compliance guidelines, and condition-specific certificate formats.
        </p>
        <p>
          Additionally, our editorial team continuously monitors prominent Indian community discussions and forums—such as <strong>Reddit (r/india, r/LegalAdviceIndia)</strong> and <strong>Quora India</strong>—to identify emerging queries. For instance, when we noticed a recurring surge in student inquiries regarding a <em>&quot;medical certificate for attendance shortage in college,&quot;</em> we developed a comprehensive guide explaining the official condonation rules, university regulations, and legal boundaries. This approach ensures our articles provide practical and highly relevant assistance.
        </p>
      </div>
    ),
  },
  {
    ...
    color: "text-pink-600",
    bg: "bg-pink-500/10",
    title: "External Links and Source Quality",
    content: (
      <div className="space-y-4 text-foreground/80 leading-relaxed">
        <p>
          We maintain a strict quality threshold for outbound references to ensure they serve as trustworthy citations. We exclusively link to high-authority domains, primarily official government portals (<strong>.gov.in</strong>) such as the <strong>Ministry of Health and Family Welfare (mohfw.gov.in)</strong>, the <strong>National Medical Commission (nmc.org.in)</strong>, and the <strong>Ministry of Personnel (persmin.gov.in)</strong> for Central Civil Services leave rules.
        </p>
        <p>
          We also refer to peer-reviewed legal and medical journals. We maintain absolute commercial independence: our content contains <strong>strictly no affiliate links</strong>, <strong>no sponsored guest posts</strong>, and <strong>no paid product placements</strong> of any kind. Every outbound link is curated strictly for its informational merit.
        </p>
      </div>
    ),
  },
