      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-16 w-full">
        ...
        <section className="mb-12">
          ...
          <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <Link href="/terms#disclaimer" className="text-primary hover:underline font-medium">disclaimer</Link>, our{" "}
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              { stat: "15+", label: "Certificate Templates" },
              { stat: "20+", label: "Blog Articles Published" },
              { stat: "100%", label: "Browser-Based Processing" },
              { stat: "Free", label: "No Payment Ever Required" },
            ].map(item => (
