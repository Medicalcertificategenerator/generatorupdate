...
const footerLinks = {
  "Generator Tools": [
    ...
    { label: "Student Leave Note", href: "/generator/janya-rx" },
  ],
  "Government Certificate Guides": [
    ...
    { label: "Medical Certificate for Leave", href: "/medical-certificate-for-leave" },
  ],
  Legal: [
  ...
  return (
    <footer className="border-t bg-muted/30 mt-auto">
      <div className="container mx-auto px-4 py-14">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-4 pt-6 pb-6 border-t border-border/50">
          <div className="flex flex-col gap-2">
            <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Get In Touch</span>
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
              <span>Email: <a href="mailto:info@medicalcertificategenerator.co.in" className="hover:text-primary transition-colors font-medium">info@medicalcertificategenerator.co.in</a></span>
              <span>Phone: <a href="tel:+919089121223" className="hover:text-primary transition-colors font-medium">+91 9089121223</a></span>
              <span>Hours: Mon-Fri: 10 am to 10 pm | Sat-Sun: 10 am to 6 pm</span>
            </div>
          </div>
        </div>
