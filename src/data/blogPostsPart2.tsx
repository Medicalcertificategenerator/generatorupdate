...
export const BLOG_POSTS_PART2: BlogPostData[] = [
      ...
      <div className="space-y-6 text-foreground/80 leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 ml-4 mt-3">
            ...
            <li><strong>Form 1A / Driving Licence:</strong> Needs to certify visual acuity. We have a dedicated <InternalLink href="/blog/form-1a-medical-certificate-explained">Form 1A guide</InternalLink> for RTO format demonstration.</li>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          <a href="https://www.nmc.org.in" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
            nmc.org.in — National Medical Commission (NMC), Government of India
          </a>
        </p>
...

  {
    ...
    featuredImage: "/images/blog/what-is-medical-fitness-certificate/featured.webp",
    featuredImageAlt: "Person exercising with a fitness certificate document beside them",
    images: [
      { src: "/images/blog/what-is-medical-fitness-certificate/content-1.webp", alt: "Fitness certificate format with fields labeled", caption: "Essential fields showing physical parameters and fitness-for-duty endorsement" },
      { src: "/images/blog/what-is-medical-fitness-certificate/content-2.webp", alt: "Doctor completing a physical examination for fitness certification", caption: "A thorough health assessment is required to endorse professional fitness-to-work" }
    ],
    ...
    content: (
      <div className="space-y-6 text-foreground/80 leading-relaxed">
        ...
        <p className="text-sm text-muted-foreground">
          External reference:{" "}
          <a href="https://www.nmc.org.in" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
            nmc.org.in — National Medical Commission: Roles of Registered Medical Practitioners
          </a>
        </p>
  ...
  },
  {
    ...
    featuredImage: "/images/blog/how-to-make-medical-certificate-for-college/featured.webp",
    featuredImageAlt: "College student holding a medical certificate with a college building in the background",
    images: [
      { src: "/images/blog/how-to-make-medical-certificate-for-college/content-1.webp", alt: "Sample student medical certificate format with labeled fields", caption: "Standard format required by universities to condone attendance shortages" },
      { src: "/images/blog/how-to-make-medical-certificate-for-college/content-2.webp", alt: "Student at college admin counter submitting documents", caption: "Students must submit original physical certificates at the administrative cell" }
    ],
    ...
    content: (
      <div className="space-y-6 text-foreground/80 leading-relaxed">
        ...
        <p className="text-sm text-muted-foreground">
          External reference:{" "}
          <a href="https://www.ugc.gov.in" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
            ugc.gov.in — University Grants Commission: Student Regulations & Attendance Policies
          </a>
        </p>
  ...
  },
  {
    ...
    featuredImage: "/images/blog/medical-certificate-kaise-banta-hai/featured.webp",
    featuredImageAlt: "Doctor writing a certificate in a clinic with Hindi label",
    images: [
      { src: "/images/blog/medical-certificate-kaise-banta-hai/content-1.webp", alt: "Flowchart in Hindi context showing steps to get a certificate", caption: "मेडिकल सर्टिफिकेट बनवाने के ४ मुख्य चरण: क्लिनिक विजिट → चेकअप → अप्रूवल → सबमिशन" },
      { src: "/images/blog/medical-certificate-kaise-banta-hai/content-2.webp", alt: "Certificate with Hindi field labels", caption: "सर्टिफिकेट के आवश्यक तत्व: डॉक्टर रजिस्ट्रेशन नंबर, निदान, और वैध आराम की अवधि" }
    ],
    ...
    content: (
      <div className="space-y-6 text-foreground/80 leading-relaxed">
        ...
        <p className="mt-4">Dekhein kaise ek real Indian medical certificate dikhta hai — <InternalLink href="/blog/medical-certificate-format-india">Medical Certificate Format India — Poora Guide</InternalLink>. Ya phir apna specimen certificate banayein hamare <InternalLink href="/">free generator</InternalLink> par.</p>
        <p className="text-sm text-muted-foreground">
          Bahari sandarbh:{" "}
          <a href="https://www.nmc.org.in" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
            nmc.org.in — National Medical Commission, Government of India
          </a>
        </p>
