...
const BLOG_POSTS_PART1: BlogPostData[] = [
  {
    ...
    featuredImage: "/images/blog/what-is-medical-certificate/featured.webp",
    featuredImageAlt: "Clean illustration of a medical certificate document with key elements labeled",
    images: [
      { src: "/images/blog/what-is-medical-certificate/content-1.webp", alt: "Doctor issuing a certificate to a patient at a clinic", caption: "A medical certificate validates an illness and certifies temporary unfitness to work" },
      { src: "/images/blog/what-is-medical-certificate/content-2.webp", alt: "Medical certificate being checked against a checklist by HR", caption: "HR managers use standard checklists to verify doctor credentials and NMC registrations" }
    ],
...

  {
    ...
    featuredImage: "/images/blog/medical-certificate-vs-prescription/featured.webp",
    featuredImageAlt: "Two documents side by side: prescription and medical certificate",
    images: [
      { src: "/images/blog/medical-certificate-vs-prescription/content-1.webp", alt: "Comparison table as visual infographic: certificate vs prescription", caption: "Comparative analysis: A prescription lists remedies, a certificate validates sick leaves" },
      { src: "/images/blog/medical-certificate-vs-prescription/content-2.webp", alt: "Doctor writing a prescription vs issuing a certificate", caption: "A patient consults the doctor to get therapies or a formal sickness report" }
    ],
    ...
    content: (
      <div className="space-y-8 text-foreground/80 leading-relaxed">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              { q: "Can I generate a mock certificate for testing?", a: "Yes, for UI/UX or developer testing, our <InternalLink href='/'>generator</InternalLink> is perfect. But never use it for real leave." },
        ...
        <p className="text-sm text-muted-foreground mt-6">
          External reference:{" "}
          <a href="https://www.who.int/standards/classifications/classification-of-diseases" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
            WHO ICD-10 — International Classification of Diseases (basis for diagnostic coding in certificates)
          </a>
        </p>
      </div>
    ),
  },
  {
    ...
    featuredImage: "/images/blog/workplace-medical-documentation/featured.webp",
    featuredImageAlt: "Office desk with medical certificate, employee folder, and calendar",
    images: [
      { src: "/images/blog/workplace-medical-documentation/content-1.webp", alt: "HR workflow diagram: certificate received, verified, filed", caption: "Standard workflow for processing and archiving corporate medical documents" },
      { src: "/images/blog/workplace-medical-documentation/content-2.webp", alt: "Employee showing medical document to HR manager", caption: "Clear communication with HR ensures smooth sick leave approvals" }
    ],
  ...
  },
  {
    ...
    featuredImage: "/images/blog/fake-medical-certificate-consequences/featured.webp",
    featuredImageAlt: "A stamped INVALID overlay on a fake document with a warning triangle",
    images: [
      { src: "/images/blog/fake-medical-certificate-consequences/content-1.webp", alt: "Courtroom illustration showing legal consequences with a gavel and documents", caption: "Presenting fraudulent medical certificates can lead to disciplinary inquiry and termination" },
      { src: "/images/blog/fake-medical-certificate-consequences/content-2.webp", alt: "BNS 2023 document illustration representing statutory forgery sections", caption: "Under Bharatiya Nyaya Sanhita (BNS) 2023, presenting fake documents is a criminal offense" }
    ],
    ...
    content: (
      <div className="space-y-8 text-foreground/80 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6 mt-10">Frequently Asked Questions</h2>
...
function getVariation(seed: string) {
  ...
  },
  {
    ...
    featuredImage: "/images/blog/indian-prescription-pad-formats/featured.webp",
    featuredImageAlt: "Three different Indian prescription pad styles side by side",
    images: [
      { src: "/images/blog/indian-prescription-pad-formats/content-1.webp", alt: "Prescription pad anatomy with fields labeled", caption: "Standard structure including GP letterhead, patient profile, and Rx clinical instructions" },
      { src: "/images/blog/indian-prescription-pad-formats/content-2.webp", alt: "Different states prescription pad format comparison", caption: "Analyzing formatting requirements across public state hospitals in India" }
    ],
  ...
  },
  {
    ...
    featuredImage: "/images/blog/is-online-medical-certificate-valid-india/featured.webp",
    featuredImageAlt: "Laptop screen showing an online medical certificate with valid green badge",
    images: [
      { src: "/images/blog/is-online-medical-certificate-valid-india/content-1.webp", alt: "Telemedicine Guidelines 2020 document illustration", caption: "Under the official Telemedicine Guidelines 2020, virtual certifications are valid" },
      { src: "/images/blog/is-online-medical-certificate-valid-india/content-2.webp", alt: "Doctor on a video call completing a telemedicine consultation", caption: "A video consult provides clinical verification prior to issuing electronic documents" }
    ],
    ...
    content: (
      <div className="space-y-8 text-foreground/80 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6 mt-10">6. Frequently Asked Questions</h2>
          <div className="grid gap-4">
            {[
  ...
  },
  {
    ...
    featuredImage: "/images/blog/who-can-issue-medical-certificate-india/featured.webp",
    featuredImageAlt: "Indian MBBS doctor in white coat writing on a prescription pad at a clinic desk",
    images: [
    ...
    content: (
      <div className="space-y-8 text-foreground/80 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6 mt-10">7. Frequently Asked Questions</h2>
          <div className="grid gap-4">
            {[
        ...
        <p className="text-sm text-muted-foreground mt-6">
          ...
          <a href="https://www.nmc.org.in" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
            nmc.org.in — National Medical Commission: Register of Licensed Medical Practitioners in India
          </a>
        </p>
      </div>
    ),
  },
  {
    ...
    featuredImage: "/images/blog/rules-medical-certificate-leave-india/featured.webp",
    featuredImageAlt: "Legal documents and a medical certificate together on a desk with a gavel icon",
    images: [
  ...
  },
  {
    ...
    featuredImage: "/images/blog/medical-certificate-vs-fitness-certificate/featured.webp",
    featuredImageAlt: "Two certificates side by side: Medical Certificate and Fitness Certificate",
    images: [
      { src: "/images/blog/medical-certificate-vs-fitness-certificate/content-1.webp", alt: "Comparison table rendered as a visual infographic", caption: "Comparing the clinical triggers, statutory targets, and HR requirements for both files" },
      { src: "/images/blog/medical-certificate-vs-fitness-certificate/content-2.webp", alt: "Doctor issuing a fitness certificate for return to work", caption: "Upon full recovery, your treating doctor certifies you as fit to resume duties" }
    ],
